...
export function NotificationsBell() {
  ...
  return (
    <div className="notif" id="notifWrap">
      <button className="icon-btn notif-btn" type="button" onClick={() => setOpen((value) => !value)} title={t("notifications")}>
        <Bell />
        <span className="notif-badge" hidden={!unread}>{unread > 99 ? "99+" : unread}</span>
      </button>
